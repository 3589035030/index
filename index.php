  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      body {
        background-image: url(https://api.cyrilstudio.top/api/bing/);
        /*下方的代码是调用bg.png作为背景，需要纯本地的将注释移除同时将上方的代码删除或注释掉*/
      ...
      <div class="container">
        <div class="glass">
          <div class="main-content">
              <h2 class="text-center" id="h">距离春节(2024年2月10日)还有：</h2>
